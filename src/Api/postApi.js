...
export const fetchSortedByRate =  (courseid) =>   Axios.get(`${url7}/${courseid}`);
export const fetchSortedByViews =  (courseid) =>   Axios.get(`${url8}/${courseid}`);
...
export const search =(search, courseid) => Axios.get(`${url5}/${search}/${courseid}`)
