...
export function AnswerQuizz({livequi}) {
  ...
  const onAnswerSubmit = (e) => {
      ...
      console.log(corect)
    socketRef.current.emit("new answer quizz", { username, answer, livequi, corect });
    e.preventDefault();
    setOpen(true);
  };
  ...
  <RadioGroup aria-label="gender" name="gender1">
    <RadioGroup aria-label="gender" name="gender1">
          <FormControlLabel value={livequi.optionOne} control={<Radio />} label={livequi.optionOne} onChange={(e) => setanswer(e.target.value)} />
          <FormControlLabel value={livequi.optionTwo} control={<Radio />} label={livequi.optionTwo} onChange={(e) => setanswer(e.target.value)} />
          <FormControlLabel value={livequi.optionThree} control={<Radio />} label={livequi.optionThree} onChange={(e) => setanswer(e.target.value)} />
          <FormControlLabel value={livequi.optionFour} control={<Radio />} label={livequi.optionFour} onChange={(e) => setanswer(e.target.value)} />
          <FormControlLabel value={livequi.optionFive} control={<Radio />} label={livequi.optionFive} onChange={(e) => setanswer(e.target.value)} />
        </RadioGroup>
  </RadioGroup>
